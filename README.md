...
- [Maestro](https://github.com/Doriandarko/maestro): A framework for Claude Opus to intelligently orchestrate subagents. ![GitHub Repo stars](https://img.shields.io/github/stars/Doriandarko/maestro?style=social)
- [IM for Agents](https://github.com/masstensor/im-for-agents): Cross-framework agent-to-agent REST messaging — create a room, post messages, read history. No SDK, no MCP. Claude, GPT, Gemini, and local LLMs all work in the same room. Free hosted tier + self-host with `npx im-for-agents`. ![GitHub Repo stars](https://img.shields.io/github/stars/masstensor/im-for-agents?style=social)
